...
import { Home, QrCode, Zap, BarChart2, User, GraduationCap, Sun, Moon } from 'lucide-react';
    ...
    <div className={`min-h-[100dvh] transition-colors duration-500 overflow-hidden ${
      ...
      <div className="w-full max-w-md relative flex h-[100dvh] flex-col overflow-hidden bg-transparent">
        ...
        <motion.header
          ...
          className="absolute top-0 left-0 right-0 z-50 border-b border-zinc-100/10 dark:border-white/5 bg-white/80 dark:bg-zinc-900/80 px-4 pb-4 pt-3 backdrop-blur-xl"
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <span className="text-base font-bold text-zinc-950 dark:text-white">Murabbiyona</span>
              </div>
            </div>
        ...
        <motion.nav
          ...
          transition={{ type: "spring", stiffness: 350, damping: 30 }}
          className="absolute bottom-0 left-0 right-0 z-50 w-full bg-white/90 dark:bg-zinc-900/90 px-1.5 pt-1.5 backdrop-blur-2xl shadow-[0_-16px_40px_rgba(0,0,0,0.05)] dark:shadow-none rounded-t-[32px] border-t border-zinc-100/60 dark:border-white/5"
